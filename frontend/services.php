    ...
    <div class="service-page">  
        <div class="service-box">
            <div class="service-logo">
                <img class="service-image"src="styles/images/IMG_0150.PNG">
            </div>
        ...
        <div class="service-box">
            <div class="service-logo">
                <img class="service-image"src="styles/images/IMG_0148.PNG">
            </div>
            <h2>Structure Damage</h2>
        ...
        <div class="service-box">
            <div class="service-logo">
                <img class="service-image"src="styles/images/IMG_0145.PNG">
            </div>
            <h2>Water/Oil Escape</h2>
            <p>Our expertise allows us to carry out escape of water/ oil contracts, working alongside specialist surveyors. Offering services from investigation works through to full reinstatement of damage.</p>
            <p>Escape of water is caused by water entering a property by the mains water supply, usually through a pipe or tank within the house. Escape of oil is similar to that of water.</p>
            <p>Henderson Building Contractors have the knowledge and confidence to reinstate the damage to its original specification. Our company strives to achieve the best in customer care, ensuring all work is done efficiently and to the personal needs of the client.</p>
        </div>
        <div class="service-box">
            <div class="service-logo">
                <img class="service-image"src="styles/images/IMG_0147.PNG">
            </div>
            <h2>Fire Damage</h2>
        ...
        <div class="service-box">
            <div class="service-logo">
                <img class="service-image"src="styles/images/IMG_0149.PNG">
            </div>
            <h2>Refurbishment</h2>
        ...
        <div class="service-box">
            <div class="service-logo">
                <img class="service-image"src="styles/images/IMG_0144.PNG">
            </div>
            <h2>Flood Damage</h2>
